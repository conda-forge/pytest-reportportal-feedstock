...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-reportportal-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13432&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-reportportal-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-reportportal` can be installed with:

```
conda install pytest-reportportal
```

It is possible to list all of the versions of `pytest-reportportal` available on your platform with:
